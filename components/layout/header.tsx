    ...
    <>
      <header className="sticky top-0 z-50 w-full bg-background/80 backdrop-blur-xl border-b border-border/50 transition-all duration-200">
        <div className="container mx-auto px-4 sm:px-4 lg:px-4">
          ...
          >
            {/* Logo. The wordmark is desktop-only: on mobile this row also
                holds the location switcher, and mark + wordmark + switcher +
                hamburger do not fit the narrowest phone widths. The mark alone
                is already the header's scrolled state, so mark-only is not a
                new look. */}
            ...
            {/* Location switcher — mobile only. Sits in the header rather than
