    ...
    >
      ...
      <MapControls
        ...
        onNearbyLocationClick={(location) => {
          const fullLocation = locationsWithDistance.find(
            (loc) => loc.properties.uniqueId === location.uniqueId,
          )
                ...
                <Card className="min-w-[220px] max-w-[280px] shadow-lg border animate-in slide-in-from-top-2 duration-300">
                  <div className="p-3">
                    ...
                    <Button
                      ...
                      onClick={() =>
                        window.open(getDirectionsUrl(popupLocation.properties.address), '_blank')
                      }
                    >
                      Get Directions
                    </Button>
                ...
                <>
                  ...
                  {locationsWithDistance.length > MAP_CONFIG.MAX_LIST_ITEMS && (
                    <p className="text-center text-sm text-muted-foreground py-2">
                      Showing {MAP_CONFIG.MAX_LIST_ITEMS} of {locationsWithDistance.length}{' '}
                      locations
                    </p>
                  )}
                </>
