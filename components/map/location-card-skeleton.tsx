...
/** Map loading skeleton — fills the 700px map slot while GeoJSON or Mapbox loads */
export function MapLoadingSkeleton() {
  return (
    <div className="relative w-full h-full min-h-[600px] bg-muted rounded-lg animate-pulse">
